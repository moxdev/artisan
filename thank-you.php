...
<html lang="en-US">
    <head>
        ...
        <title>Washington DC Apartments | Artisan 4100</title>
            ...
            <header id="masthead">
                ...
                <div class="social">
                    <div class="social-wrapper">
                        <div class="email">
                            <a href="mailto:info@artisanat4100.com">info@ArtisanAt4100.com</a>
                        </div>
                    </div>
                </div>
            </header>
            <main id="main">
                <article>
                    <div class="header-img">
                        <img src="imgs/artisan-exterior.jpg" alt="Artisan 4100 Exterior" class="highlight-img">
                        <div class="header-callout">Opening 2018</div>
                    </div>
                    ...
                    <div class="pics">
                        <div class="pic-wrap">
                            <img src="imgs/box/lounge-2.jpg" alt="Lounge">
                        </div>
                        <div class="pic-wrap">
                            <img src="imgs/box/bike.jpg" alt="Bike">
                        </div>
                        <div class="pic-wrap">
                            <img src="imgs/box/lounge-1.jpg" alt="Lounge">
                        </div>
                        <div class="pic-wrap">
                            <img src="imgs/box/electric-car.jpg" alt="Electric Car">
                        </div>
                    </div>
                </article>
            </main><!-- #main -->
